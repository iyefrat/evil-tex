...
*** TODO Make Text Objects Work with Surround
...
Look into ~outline-mode~ for the actual folding. I heard that AUCTeX already
defines some stuff for outline, we should look into that.
