...
** TODO fix envs not understanding nesting, adapt delim algorithm
...
** TODO change =mtS= functionality to change name of section
** TODO steal org heading prompotion/demotion, maybe more?
** TODO Reach out to the original evil-LaTeX-txtobjs author
** WAIT bind textobjects on local keymap
waiting on =evil-surround= issue
