...
(defvar evil-tex-env-fallback-evil-org t
  "Non-nil to fallback to `evil-org-an-object' and
`evil-org-inner-object' when `org-mode' and `evil-org-mode' is
enabled.")
...
(evil-define-text-object evil-tex-an-env (count &optional beg end type)
  ...
  (condition-case err (nbutlast (evil-tex--select-env) 2)
    (error (cond
            ...
            ((and evil-tex-env-fallback-evil-org (derived-mode-p 'org-mode) (fboundp 'evil-org-an-object))
