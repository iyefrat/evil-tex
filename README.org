...
* Installation
This package can be installed from MELPA, or by cloning it and put it in the load path. For ease use, hook it to =LaTeX-mode= by adding the following to your configuration:
